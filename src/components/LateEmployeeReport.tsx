    ...
    try {
      ...
      Object.entries(employeesByDepartment).forEach(([department, employees]) => {
        ...
        (doc as any).autoTable({
          head: [['Employee Name', 'Position', 'Roster Start', 'Check-in', 'Late By']],
          body: tableData,
          startY: yPosition,
          theme: 'grid',
          headStyles: { 
          ...
          columnStyles: {
            0: { cellWidth: 45 },  // Employee Name
            1: { cellWidth: 35 },  // Position
            2: { cellWidth: 25 },  // Roster Start
            3: { cellWidth: 25 },  // Check-in
            4: { cellWidth: 25 }   // Late By
          },
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead>Roster Start</TableHead>
                    ...
                    <TableBody>
                      {employees.map((employee) => (
                        <TableRow key={employee.id}>
                          ...
                          <TableCell>{employee.roster_start_time}</TableCell>
                          <TableCell>
